...
5E2: Animal diversity is linearly related to latitude, but only after controlling for plant diversity.
...
See if you can come up with a cogsci-inspired phenomenon. Anxiety? Bliss? Make a DAG and use the *dagitty* package to illustrate it. 
